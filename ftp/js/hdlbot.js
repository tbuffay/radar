...
function statusUpdate() {
    ...
    req.onreadystatechange = function () {
        if (req.readyState == 4 && req.status == 200) {
            ...
            document.getElementById('motorRpm').innerHTML = status.motor.rpm;
            document.getElementById('motorLock').innerHTML = status.motor.lock;
            document.getElementById('motorPhase').innerHTML = status.motor.phase;
