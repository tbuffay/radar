...
function scale_volt_temp(volt_temp) {
	...
	volt_temp.bot.lm20_temp *= scale_2x_vref;
	volt_temp.bot.pwr_5v *= scale_2x_vref;
	volt_temp.bot.pwr_3_3v *= scale_2x_vref;
...
function diagnosticsUpdate() {
    ...
    req.onreadystatechange = function () {
        if (req.readyState == 4 && req.status == 200) {
            ...
            updateFixed("bot_i_out", diag.volt_temp.bot.i_out/5.0, 1);
            ...
            updateFixed("bot_pwr_v_in", diag.volt_temp.bot.pwr_v_in/2000.000, 3);
